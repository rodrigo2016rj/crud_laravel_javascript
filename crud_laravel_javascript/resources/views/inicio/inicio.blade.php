...
<div id="div_pagina_inicio">
  ...
  <div id="div_sobre_este_sistema">
    ...
    <div id="div_conteudo_sobre_este_sistema">
      <p>
        Fiz este sistema para divulgar a minha forma de utilizar Laravel sem frameworks javascript, 
        ou seja Laravel com Javascript puro. Este sistema possui as quatro operações básicas: Create 
        (INSERT), Read (SELECT), Update (UPDATE) e Delete (DELETE), por isso o nome do sistema é 
        CRUD Laravel Javascript. No menu do sistema há 4 links:
      </p>
      <p>
